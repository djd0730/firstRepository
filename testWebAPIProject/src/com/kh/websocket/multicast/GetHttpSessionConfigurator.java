...
// Configurator : 사용자 연결을 위한 websocket객체를 생성할 때 기본적으로 설정할 정보들을 작성하는 클래스 

// Configurator 클래스를 상속 받을 경우 modifyHanshake() 메소드를 통해 webSocket.Session을 통해 전달할 데이터를 HttpSession과 연결하여 데이터를 담을 수 있다.
...
public class GetHttpSessionConfigurator extends Configurator{
    ...
    @Override
       ...
       {
    	// config 는 기존 설정 부분을 가져와서 수정할 때 사용하는 객체
