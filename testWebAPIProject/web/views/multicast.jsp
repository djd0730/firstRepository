...
<body>
	<h1>Multicast 란?</h1>
	<h3>하나의 네트워크 안의 여러 사용자 중 특정한 그룹에 속한 사용자끼리 소통하는 1:m 의 통신 방식</h3>
	<p>Ex) 단체 카톡, 디스코드 톡, 게임 톡, 스카이프</p>
	<br />
	<form action="<%=request.getContextPath()%>/multiChatRoom.do" method="post">
		...
		<!-- 새로운 채팅방을 개설할 경우 -->
		<h3 class="createRoom">방 제목 : <input type="text" name="roomName" id="roomName" size="10"/></h3>
